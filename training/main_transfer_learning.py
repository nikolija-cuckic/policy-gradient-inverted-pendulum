...
def transfer_weights(source_agent, target_agent):
    ...
    # policy network (same size in both models)
    try:
        ...
        print("Policy network transferred")
...
def train_transfer(seed=1, total_episodes=2000):
    ...
    # create target model (double pendulum)
